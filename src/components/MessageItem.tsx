  ...
  return (
    <div class="py-2 -mx-4 px-4 transition-colors md:hover:bg-slate/3">
      <div class="flex gap-3 rounded-lg" class:op-75={role === 'user'}>
        <div class={`min-w-7 min-h-7 mt-4`}>
          {role === 'user' ? <img class="rounded-full" src={UserAvatar}/> : <Bot />}
        </div>
        <div class="message prose break-words overflow-hidden" innerHTML={htmlString()} style="max-width:100ch" />
      </div>
      {showRetry?.() && onRetry && (
